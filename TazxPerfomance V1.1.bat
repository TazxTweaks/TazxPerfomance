...
if '%choice%'=='B' goto Bios
if '%choice%'=='W' goto winOS
if '%choice%'=='w' goto winOS
if '%choice%'=='D' goto Dwn
if '%choice%'=='d' goto Dwn
...
echo -----------------------------------------------------------------------------------------------------------------------
:st
echo TAZX APP Management Utility
echo.
echo 1 - Download Discord
echo 2 - Download Epic Games Launcher
echo 3 - Download OBS Studio
echo 4 - Download VLC Media Player
echo 5 - Download Spotify
echo 6 - Menu
echo.

set choice=
set /p choice=Type the Number to Download=
if not '%choice%'=='' set choice=%choice:~0,1%
if '%choice%'=='1' goto Discord
if '%choice%'=='2' goto Epic
if '%choice%'=='3' goto OBS
...
:OBS
Start https://cdn-fastly.obsproject.com/downloads/OBS-Studio-26.1.1-Full-Installer-x64.exe
cls
goto st

:VLC
Start https://get.videolan.org/vlc/3.0.12/win64/vlc-3.0.12-win64.exe
cls
goto st
